const combinations = {
    ...
    badsoft: ["malware", "spyware", "adware", "DRM", "viruses", "trojans", "keyloggers", "stolen code", "easter eggs", "potential login stealers", "adf.ly links", "bad code", "stolen assets", "malicious code", "secret backdoors", "kangarko/Foundation", "obfuscation", "Songoda plugins", "ransomware", "remote code execution", "precompiled Spigot binaries", "force ops", "server crashers", "arbitrary JavaScript execution"],
...
const sentences = [
    ...
    "[people] releases [code] from [things] as a standalone library for [function]",
    "[people] [says] users of [things] should feel bad",
    "[people] rewrites [things] to focus on [function] instead of [function]"
];
