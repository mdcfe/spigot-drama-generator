const combinations = {
    people: ["md_5", "Choco", "Aikar", "kashike", "electroniccat", "Z750", "LaxWasHere", "wizjany", "Me4502", "mbaxter", "Amaranth", "Tux", "andrewkm", "KHobbits", "ElgarL", "md678685", "Trent", "SupaHam", "pop4959", "JRoy", "zml", "Luck", "Proximyst", "Glare", "simpleauthority", "garbagemule", "DemonWav", "Songoda", "kangarko", "MiniDigger", "libraryaddict", "Puremin0rez", "Intelli", "KennyTV", "mikroskeem", "nossr50", "BtoBastian", "Proxymist", "Citymonstret", "Turbotailz", "Larry", "Phoenix616", "Spottedleaf", "stefvanschie", "Byteflux", "Camm", "BillyGalbreath", "vk2gpz", "bloodmc", "gabizou", "TheBusyBiscuit"],
    sites: ["SpigotMC Forums", "Minecraft Forums", "Reddit", "/r/admincraft", "PaperMC Discord", "GitHub", "SpigotMC JIRA", "IRC", "SpigotMC Resources", "Patreon", "wiki.vg/Protocol", "Twitch", "MCMarket", "Songoda.com", "MineAcademy", "Hangar", "BukkitDev", "Ore", "bStats", "SpigotMC Discord", "SpigotMC IRC", "EsperNet", "MOSS Discord", "EssentialsX issue tracker", "Sponge Forums"],
    things: ["Paper", "Spigot", "Bungeecord", "CraftBukkit", "Fukkit", "Velocity", "EssentialsX", "GroupManager", "LuckPerms", "PermissionsEx v1", "Vault", "VanishNoPacket", "FactionsUUID", "Waterfall", "Tuinity", "Purpur", "LWC", "TreeAssist", "ChatControl", "ProtocolLib", "ViaVersion", "ViaRewind", "ViaBackwards", "ProtocolSupport", "Dynmap", "Fabric", "WorldEdit", "WorldGuard", "CraftBook", "Sponge", "SpongeForge", "SpongeVanilla", "Forge", "Mojang", "open-source plugins", "closed-source plugins", "free plugins", "premium plugins", "CMI", "Genders", "EpicGenders", "MobArena", "Hangar", "the Bukkit API", "TruAntiLag", "MiniMessage", "MineDown", "mcMMO", "Lib's Disguises", "CoreProtect", "Prism", "LogBlock", "NuVotifier", "Votifier", "Ore", "bStats", "kyori/text", "kyori/adventure", "RotatoR", "LuckPerms Web Editor", "Chester", "EngineHub", "ChestShop", "Nucleus", "Skript", "Denizen", "Helper", "spark", "Towny", "FastAsyncWorldEdit", "PlotSquared", "Multiverse", "GriefPrevention", "GriefDefender", "Travertine", "ACF", "Brigadier", "Citizens", "RedisBungee", "Flamecord", "Slimefun"],
    ...
    crash: ["crash", "explode", "break", "lag", "blow up", "corrupt chunks", "corrupt worlds", "rain hellfish", "spawn bees", "drop /nuke", "hold servers ransom", "nullping crash", "overloaded Netty threads"],
    ...
    says: ["says", "tweets", "claims", "confirms", "denies", "announces", "agrees", "spams", "declares", "pings @everyone to announce", "rants", "locks the SpigotMC Discord for a two hour long monologue because", "activates Discord slow mode because"],
