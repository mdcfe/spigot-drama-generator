const combinations = {
    ...
    ban: ["ban", "kick", "put a pumpkin of shame on", "add commands mocking", "blacklist", "whitelist", "give admin rights to", "shame", "destroy", "ping wizjany"],
    ...
    price: ["$100", "$200", "$250", "$300", "$350", "$400", "$450", "$500", "$600", "$1 Million"],
