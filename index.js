const combinations = {
    people: ["md_5", "Choco", "Aikar", "kashike", "electroniccat", "Z750", "LaxWasHere", "wizjany", "Me4502", "mbaxter", "Amaranth", "Tux", "andrewkm", "KHobbits", "ElgarL", "md678685", "Trent", "SupaHam", "pop4959", "JRoy", "zml", "Luck"],
...
<html>
    ...
    <body>
        ...
        <h1>${message}</h1>
        <h6>Inspired by (and heavily borrows from) <a href="https://github.com/asiekierka/MinecraftDramaGenerator/">asiekierka's Minecraft Drama Generator</a>.<br /><a href="/">Generate more drama!</a> <a href="${share}">(permalink)</a></h6>
    </body>
</html>
    `
}
